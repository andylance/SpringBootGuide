...
public class RedisCacheManager implements CacheManager {
     ...
     */
    public static final String DEFAULT_CACHE_KEY_PREFIX = "shiro_cache_";
    ...
    public <K, V> Cache<K, V> getCache(String name) throws CacheException {
        ...
        if (cache == null) {
            cache = new RedisCache<K, V>(redisManager, keySerializer, valueSerializer,
                    keyPrefix + name + ":", expire, principalIdFieldName);
